...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const texts = [
        { text: "경기도 부천시 원종역 인근", offsetX: -500, offsetY: -400, color: "#000000" }, // 中间上方
        { text: "장어는 맛 그 이상<br><br>하나의 체험입니다", offsetX: 0 ,offsetY: 0, color: "#ffffff" }, // 正中
        { text: "내 손으로 굽는<br><br>나만의 맛", offsetX: 500, offsetY: 400, color: "#ffffff" } // 中间下方
    ];
